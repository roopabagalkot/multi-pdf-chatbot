...
def get_conversational_chain():
    ...
    respond with: "Answer is not available in the context." Do not make up answers.

    Context:\n{context}\n
    Question:\n{question}\n
    Answer:
    """
    model = ChatGoogleGenerativeAI(model="models/gemini-2.0-flash", convert_system_message_to_human=True)
